...
public class cppLanguage extends AppCompatActivity {
    TextView ques,progressText;
    TextView op1,op2,op3,op4;
    Button sub;
    int score=0,selectOption=0;
    ProgressBar progressBar;
    int totalQuestion=questionData.questionForCPP.length;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sub.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    if (selectAnswer.equals(questionData.correctAnswerForCPP[currentQuestionIndex])) {
                        score++;
                        Toast.makeText(cppLanguage.this, "correct", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    Intent i=new Intent(cppLanguage.this,FinalResult.class);
                    startActivity(i);
                }
    ...
    private void setQuestion() {
        ...
        ques.setText(questionData.questionForCPP[currentQuestionIndex]);
        op1.setText(questionData.choicesForCPP[currentQuestionIndex][0]);
        op2.setText(questionData.choicesForCPP[currentQuestionIndex][1]);
        op3.setText(questionData.choicesForCPP[currentQuestionIndex][2]);
        op4.setText(questionData.choicesForCPP[currentQuestionIndex][3]);
