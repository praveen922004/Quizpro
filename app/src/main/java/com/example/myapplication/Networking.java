...
public class Networking extends AppCompatActivity {
    ...
    int totalQuestion=questionData.questionForCN.length;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sub.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    if (selectAnswer.equals(questionData.correctAnswerForCN[currentQuestionIndex])) {
                        score++;
                        Toast.makeText(Networking.this, "correct", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    Intent i=new Intent(Networking.this,FinalResult.class);
                    startActivity(i);
                }
    ...
    private void setQuestion() {
        ...
        ques.setText(questionData.questionForCN[currentQuestionIndex]);
        op1.setText(questionData.choicesForCN[currentQuestionIndex][0]);
        op2.setText(questionData.choicesForCN[currentQuestionIndex][1]);
        op3.setText(questionData.choicesForCN[currentQuestionIndex][2]);
        op4.setText(questionData.choicesForCN[currentQuestionIndex][3]);
