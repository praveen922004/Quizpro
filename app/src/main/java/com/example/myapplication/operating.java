...
public class operating extends AppCompatActivity {
    ...
    int totalQuestion=questionData.questionForOS.length;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sub.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    if (selectAnswer.equals(questionData.correctAnswerForOS[currentQuestionIndex])) {
                        score++;
                        Toast.makeText(operating.this, "correct", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    Intent i=new Intent(operating.this,FinalResult.class);
                    startActivity(i);
                }
    ...
    private void setQuestion() {
        ...
        ques.setText(questionData.questionForOS[currentQuestionIndex]);
        op1.setText(questionData.choicesForOS[currentQuestionIndex][0]);
        op2.setText(questionData.choicesForOS[currentQuestionIndex][1]);
        op3.setText(questionData.choicesForOS[currentQuestionIndex][2]);
        op4.setText(questionData.choicesForOS[currentQuestionIndex][3]);
