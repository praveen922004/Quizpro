...
public class MicroProccessor extends AppCompatActivity {
    ...
    int totalQuestion=questionData.questionForMP.length;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_micro_proccessor);
        ...
        sub.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    if (selectAnswer.equals(questionData.correctAnswerForMP[currentQuestionIndex])) {
                        score++;
                        Toast.makeText(MicroProccessor.this, "correct", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    Intent i=new Intent(MicroProccessor.this,FinalResult.class);
                    startActivity(i);
                }
    ...
    private void setQuestion() {
        ...
        ques.setText(questionData.questionForMP[currentQuestionIndex]);
        op1.setText(questionData.choicesForMP[currentQuestionIndex][0]);
        op2.setText(questionData.choicesForMP[currentQuestionIndex][1]);
        op3.setText(questionData.choicesForMP[currentQuestionIndex][2]);
        op4.setText(questionData.choicesForMP[currentQuestionIndex][3]);
